...
import pl.umcs.visitor.implementation.JsonVisitor;
import pl.umcs.visitor.implementation.XmlVisitor;
...
public class VisitorPresentation {
    ...
    public static void main(String[] args) {
        ...
        HoldingCompany main = new HoldingCompany("Fourth company", "Krakowskie przedmiescia", "1234567891", singletonList(valueOf(30000L)), singletonList(valueOf(600000L)), singletonList("Placek"), asList(third, second));

        log.info("Holding company serialized to JSON: {}", main.acceptVisitor(new JsonVisitor()));

        log.info("Holding company serialized to XML: {}", main.acceptVisitor(new XmlVisitor()));
    }
}
